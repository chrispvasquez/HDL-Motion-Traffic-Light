...
HD_PWD='C:/Users/chris/OneDrive/Desktop/DigLog Project CV/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log controller_CV.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source controller_CV.tcl -notrace
