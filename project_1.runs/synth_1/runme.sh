...
HD_PWD='C:/Users/chris/OneDrive/Desktop/DigLog Project CV/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log controller_CV.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source controller_CV.tcl
